          ...
          <div className="w-full max-w-2xl flex-1 flex flex-col">
              ...
              <div className="space-y-1 sm:space-y-2">
                {Object.entries(
                  ...
                  <div key={option} className="group">
                    <label
                      className={`flex items-start cursor-pointer p-1 sm:p-2 rounded-lg border transition-all duration-200 ${answers[currentQuestion.question_id] === option
            ...
            <div className="flex justify-between items-center mt-8">
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-colors duration-200 ${currentQuestionIndex === 0
              ...
              {isLastQuestion ? (
                <button
                  ...
                  className={`px-4 sm:px-6 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-colors duration-200 ${!answers[currentQuestion?.question_id] || isSubmitting
                    ? "bg-gray-200 text-gray-400 cursor-not-allowed"
                ...
                <button
                  ...
                  className={`px-4 sm:px-6 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition-colors duration-200 ${!answers[currentQuestion?.question_id]
                    ? "bg-gray-200 text-gray-400 cursor-not-allowed"
                    : "bg-blue-600 text-white hover:bg-blue-700 cursor-pointer"
                    }`}
                >

      ...
      <div className="layout-container flex h-full grow flex-col">
        <div className="px-6 py-5 overflow-hidden">
          ...
          <div className="flex w-full h-[calc(100%-36px)] min-w-0 bg-white py-4 px-5">
            ...
            <div className="flex flex-col h-[calc(100vh-156px)] pr-5 border-r border-[#E5E7EB] flex-shrink-0" style={{ width: "70%" }}>
              {/* Main Video/Slide Section Skeleton */}
              <div className="bg-white rounded-xl border border-[#E5E7EB] min-h-[400px] relative animate-pulse flex-1">
                ...
                <div className="overflow-x-auto overflow-y-visible">
                  <div className="flex gap-2 pb-1.5 pt-5 overflow-y-visible animate-pulse">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div
                        key={i}
                        className="flex-shrink-0 w-[119px] h-[68px] bg-white border border-[#E5E7EB] rounded-lg"
                      >
            ...
            <div className="flex flex-col h-full relative gap-4 flex-shrink-0 pl-4" style={{ width: "30%" }}>
              ...
              <div className="p-3 pb-2 bg-white rounded-xl border border-[#E5E7EB] animate-pulse">
              ...
              <div className="flex flex-col items-start p-3 gap-2.5 w-full flex-1 border border-[#E5E7EB] rounded-xl bg-white animate-pulse">
